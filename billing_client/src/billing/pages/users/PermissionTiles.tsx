...
export const permIcon = (name: string) => {
  ...
  if (n.includes('incentive') && n.includes('report')) return 'fas fa-coins';
  if (n.includes('incentive')) return 'fas fa-gift';
  if (n.includes('attendance') && n.includes('report')) return 'fas fa-clipboard-list';
  if (n.includes('attendance')) return 'fas fa-user-clock';
  if (n.includes('today') && n.includes('collection')) return 'fas fa-calendar-day';
  if (n.includes('collection')) return 'fas fa-chart-line';
  if (n.includes('salon') || (n.includes('bill') && !n.includes('stock'))) return 'fas fa-file-invoice';
